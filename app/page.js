  ...
  return (
    <div className="min-h-screen w-full bg-gray-100 text-gray-900 flex flex-col">
      ...
      <div className='flex-grow p-4 bg-blue-950 flex flex-col items-start gap-2 sm:flex-row'>
        <main className="flex-grow p-4 bg-white shadow-lg rounded-lg flex sm:flex-col items-stretch justify-start gap-2 sm:w-full h-full">
        <div className="flex-grow bg-white flex sm:flex-row items-center justify-between gap-2 sm:w-full h-1/4">
